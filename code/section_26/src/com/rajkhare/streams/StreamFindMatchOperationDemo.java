...
public class StreamFindMatchOperationDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(anyOnSale);// ture

        // Check if any item is out of stock
        boolean anyOutOfStock = items.stream().anyMatch(item -> !item.isInStock());
        System.out.println(anyOutOfStock);// ture

        // Check if all items less than or equal to 5000
        ...
        // Fetch a first item that has price greater than 1000
    ...
    private static List<Item> getItems() {
        return List.of(
                ...
                new Item("Headphone", 150, false, true),
